...
const { Wallet, TxType, providers } = require("@kaiachain/ethers-ext/v6");
const { getKlaytnKmsEthers } = require("../utils/awskms");
const {
  getTransactionRequest,
} = require("@kaiachain/ethers-ext/src/v5/txutil");
...
// );
const provider = getKlaytnKmsEthers();
