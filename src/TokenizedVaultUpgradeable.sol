...
abstract contract ERC4626FeesUpgradeable is ERC4626Upgradeable {
  ...
  function __ERC4626Fees_init(uint256 _basisPointsFees, address _treasury) internal onlyInitializing {
...
contract TokenizedVaultUpgradeable is ERC4626FeesUpgradeable {
  ...
  function initialize(IERC20 _asset, uint256 basisPointsFees, address treasury) external initializer
  {
    __ERC4626Fees_init(basisPointsFees, treasury);
